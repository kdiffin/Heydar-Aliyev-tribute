...
function Nəsihətləri() {
  ...
  return (
    <section
      ...
      snap-center  items-center justify-center text-center w-full h-screen"
    >
      <div
        id="nəsihətləri"
        className="w-full   snap-center relative  flex justify-center items-center  h-screen bg-gradient-to-b from-gray-800 to-black text-white"
      >
        <div className="max-w-screen-lg p-4 pb-56 mx-auto flex flex-col justify-center w-full">
          <div className="pb-8">
